...
class testAllWebServicesEndToEnd(unittest.TestCase):
    def testAllWebServicesEndToEnd(self):
        ...
        self.assertEqual(204, delete_competition_response_status_code, msg="Failed to hit the endpoint at {uri} as we got the status code of {status_code}".format(uri=delete_competition_uri, status_code=delete_competition_response_status_code))
