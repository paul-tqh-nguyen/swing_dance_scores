...
class testAllWebServicesWrtAuthenticationViaLocalFireStoreEmulator(unittest.TestCase):
    def testAllWebServicesWrtAuthenticationViaLocalFireStoreEmulator(self):
        try:
            ...
            self.assertEqual(201, signup_response_status_code, msg="Failed to hit the endpoint at {uri} as we got the status code of {status_code}.".format(
                uri=get_all_competitions_uri, status_code=signup_response_status_code))
