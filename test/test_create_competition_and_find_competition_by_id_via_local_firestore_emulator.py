...
class testCreateCompetitionAndFindCompetitionByIdViaLocalFirestoreEmulator(unittest.TestCase):
    def testCreateCompetitionAndFindCompetitionByIdViaLocalFirestoreEmulator(self):
        try:
            ...
            self.assertTrue("competitionName" in only_competition_via_find_competition_endpoint, msg="Competition malformed as no creator handle was specified. The competition info is {result}.".format(result=only_competition_via_find_competition_endpoint))
            ...
            self.assertTrue("category" in only_competition_via_find_competition_endpoint and only_competition_via_find_competition_endpoint["category"], msg="We could not gather the competition category set (i.e. {category}) when we created the competition. The competition data is {competition_data} ".format(category=category, competition_data=json.dumps(only_competition_via_find_competition_endpoint)))
