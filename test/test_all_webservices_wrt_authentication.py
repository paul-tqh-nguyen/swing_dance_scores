...
class testAllWebServicesWrtAuthentication(unittest.TestCase):
    def testAllWebServicesWrtAuthentication(self):
        ...
        valid_handle = "valid_user_{timestamp}".format(timestamp=str(time.time()))
        valid_email = "{valid_handle}@email.com".format(valid_handle=valid_handle)
        valid_user_password = random_string()
